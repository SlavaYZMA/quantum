...
const translations = {
    ru: {
        ...
        warning_language: "[ПРЕДУПРЕЖДЕНИЕ] Для лучшего опыта используйте компьютер или переключитесь на режим для ПК в браузере телефона.",
        warning_step0: "[ПРЕДУПРЕЖДЕНИЕ] Для лучшего опыта используйте компьютер или переключитесь на режим для ПК в браузере телефона.",
    ...
    eng: {
        ...
        warning_language: "[WARNING] For the best experience, use a computer or switch to desktop mode in your mobile browser.",
        warning_step0: "[WARNING] For the best experience, use a computer or switch to desktop mode in your mobile browser.",
