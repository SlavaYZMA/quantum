...
window.translations = {
    'ru': {
        ...
        'step3_text2': '> Каждому пикселю назначены параметры (x, y, brightness, color) <span class="green-text"> (x, y, brightness, color)</span>.',
        'step3_text3': '> На их основе построена волновая функция: ψ(x, y, t) <span class="green-text"> ψ(x, y, t)</span>.',
        'step3_text4': 'Уравнение эволюции:',
        'step3_text5': 'iℏ ∂ψ/∂t = Ĥψ, где Ĥ = -½∇² + V(x, y)',
        'step3_text6': '> Потенциал V(x, y) <span class="green-text"> V(x, y)</span> формируется из визуальных характеристик изображения.',
    ...
    'eng': {
        ...
        'step1_text3': '> Here observation = intervention',
        'step2_title': 'Step 1: Scan the superposition face.',
        'step2_text1': 'You can upload an image or select from the archive.',
        ...
        'step3_text2': '> Each pixel assigned parameters (x, y, brightness, color) <span class="green-text"> (x, y, brightness, color)</span>.',
        'step3_text3': '> Based on them, a wave function is built: ψ(x, y, t) <span class="green-text"> ψ(x, y, t)</span>.',
        'step3_text4': 'Evolution equation:',
        'step3_text5': 'iℏ ∂ψ/∂t = Ĥψ, where Ĥ = -½∇² + V(x, y)',
        'step3_text6': '> Potential V(x, y) <span class="green-text"> V(x, y)</span> is formed from the visual characteristics of the image.',
        'step3_text7': '> System switches to time simulation mode.',
        ...
        'step5_text2': 'But you can capture one moment.',
        'step5_text3': 'This will be one of the possible you.',
