...
window.selectLanguage = function(lang) {
  ...
  document.querySelectorAll('[data-i18n]').forEach(element => {
    ...
    if (window.translations[lang][key]) element.textContent = window.translations[lang][key];
  });
...
window.goToStep = function(step) {
  ...
  if (step === 0) window.typeText('typewriter0', window.translations[window.language].step0);
  else if (step === 1) {
    setTimeout(() => {
  ...
  } else if (step === 2) window.typeText('typewriter2', window.translations[window.language].step2);
  else if (step === 3) {
    window.typeText('typewriter3', window.translations[window.language].step3);
    if (window.img && window.isCanvasReady) window.p5Instance.loop();
  } else if (step === 4) {
    ...
    if (window.img && window.isCanvasReady) window.p5Instance.loop();
  } else if (step === 6) window.typeText('typewriter6', window.translations[window.language].step6);
  else if (step === 7) window.typeText('typewriter7', window.translations[window.language].step7);
  document.querySelectorAll('.continue-button').forEach(btn => btn.style.display = 'block');
};
...
window.goToArchive = function() {
  alert('Archive not available yet.');
};
